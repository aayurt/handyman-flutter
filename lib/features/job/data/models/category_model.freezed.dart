...
class _$_CategoryModel implements _CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, title: $title, description: $description, image: $image, status: $status)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, image, status);
...
abstract class _CategoryModel implements CategoryModel {
  const factory _CategoryModel(
      ...
      final String? description,
      final String? image,
      final String? status}) = _$_CategoryModel;
